...
export type DiffRule<W extends WorkflowDiffBase = WorkflowDiffBase, N extends W['nodes'][number] = W['nodes'][number]> = (prev: W, next: W, diff: WorkflowChangeSet<N>) => boolean;
export declare function groupWorkflows<W extends WorkflowDiffBase = WorkflowDiffBase>(workflows: W[], rules: Array<DiffRule<W>>, skipRules?: Array<DiffRule<W>>): {
    removed: W[];
    remaining: W[];
};
/**
